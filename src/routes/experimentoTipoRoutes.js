...
/**
 * Ruta GET para obtener un tipo de experimento por ID.
 * @name get/experimento_tipo/:id
 * @function
 */
router.get('/:id', authMiddleware, experimentoTipoController.obtenerPorId.bind(experimentoTipoController));
 ...
 * @name patch/experimento_tipo/:id
 * @function
 */
router.patch('/:id', authMiddleware, soloEditores, experimentoTipoController.actualizar.bind(experimentoTipoController));

/**
 * Ruta DELETE para eliminar un tipo de experimento.
 * @name delete/experimento_tipo/:id
 * @function
 */
router.delete('/:id', authMiddleware, soloEditores, experimentoTipoController.eliminar.bind(experimentoTipoController));
