...
app.use('/celulas-proyecto', celulaProyectoRoutes);
app.use('/empleados', empleadoRoutes);
app.use('/secuencias', secuenciaRoutes);
app.use('/categorias', categotiaRoutes);
app.use('/experimentos-tipos', experimentosTipoRoutes);
app.use('/testing-cards', testingCardRoutes);
app.use('/learning-cards', learningCardRoutes);
app.use('/metricas-testing-card', metricaTestingCardRoutes);
app.use('/urls-testing-card', urlTestingCardRoutes);
app.use('/urls-learning-card', urlLearningCardRoutes);
app.use('/posiciones-flujo', nodePositionRoutes);
app.use('/testing-cards-playbook', testingCardPlaybookRoutes);
app.use('/testing-cards', testingCardDocumentRoutes);
app.use('/learning-cards', learningCardDocumentRoutes);
app.use('/usuarios', usuarioRoutes);
app.use('/usuarios-proyectos', usuarioProyectoRoutes);
app.use('/auth', authRoutes);
app.use('/agentes', agenteRoutes);
app.use('/agentes-categorias', agenteCategoriaRoutes);
app.use('/plantillas-testing-card', plantillaTestingCardRoutes);
app.use('/plantillas-metricas-tc', plantillaMetricaTcRoutes);
app.use('/plantillas-secuencias', plantillaSecuenciaRoutes);
app.use('/notificaciones', notificacionRoutes);
app.use('/search', searchRoutes);
app.use('/urls-formatos', urlFormatoRoutes);
